...
Form state. Dictionary of Form Controls where the key is a period saparated representation fo the [`ControlRef`](#api-control-ref) tuple.
...
| chilrenValid | Valid status of direct child controls.
