...
1. [Examples](#examples) 1. [Basic Control](#basic-control) 1. [Validation](#validation) 1. [Async Validation](#async-validation) 1. [Form Arrays](#form-arrays) 1. [Resetting Forms](#resetting-forms)
      </div>
...
<a
  href="https://raw.githubusercontent.com/reactables/reactables/main/assets/docs/Slide10ReactablesForms.jpg"
  target="_blank"
>
  <img
    src="https://raw.githubusercontent.com/reactables/reactables/main/assets/docs/Slide10ReactablesForms.jpg"
    width="700"
  />
</a>
  ...
  {() => {
    return (
      <div className="form-group">
        <Field controlRef={['firstName']} component={Input} label="First Name (required)" />
        <Field controlRef={['lastName']} component={Input} label="Last Name (required)" />
      </div>
    );
  }}
</Form>
...
>
  {() => (
    <div className="form-group">
      <Field controlRef={['firstName']} component={Input} label="First Name" />
      <Field controlRef={['lastName']} component={Input} label="Last Name" />
      <Field
        controlRef={['email']}
        component={Input}
        label={
